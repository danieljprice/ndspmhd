...
!      
 ...
 OPEN(UNIT=iread,ERR=999,FILE=infile,STATUS='replace',FORM='formatted')
  ...
  WRITE(iread,40) iener,udiss_frac,Bdiss_frac,polyk
...
40 FORMAT(i1,2x,f5.3,2x,f5.3,2x,f5.3,21x,'! type of energy equation, udiss_frac, Bdiss_frac(for iner=3), polyk(for iener=0)')
...
130 FORMAT(i2,35x,'! divergence correction method (0:none 1:projection 2: kernel 3: Borve 4: Joe 5: dans kernel)')
