...
module part_in
 ...
 real, dimension(:),   allocatable :: dusttogasin
end module
...
module rates
 ...
 real, dimension(:), allocatable   :: ddusttogasdt
 real :: potengrav
end module rates
...
!--integrator tolerance
  ...
  real, dimension(:,:), allocatable :: v1,v2,v3,v4,v5,v6
  real, dimension(:,:), allocatable :: f1,f2,f3,f4,f5,f6
  real, dimension(:), allocatable :: dh1,dh2,dh3,dh4,dh5,dh6
