...
!            
 ...
 integer :: i,k,iring,ipart,npartphi,npartz,nringsguess,nrings
 ...
 real :: phi,phimin,phimax,zmin,zmax,dz
 real :: rhor,drhor
 real :: gamm1

 write(iprint,*) 'Accretion disc setup in 3D'
...
!--allocate memory
!
 call alloc(nrings*npartphi*npartz)
!
!--determine particle mass
!
 ntotal = nrings*npartphi*npartz
 volume = (pi*(rmax**2 - rmin**2))*(zmax-zmin)
...
!---------------------------------------------
 do iring=1,nrings
    ...
    do i=1,npartphi
       ...
       if (ndim.ge.3) x(3,ipart) = zmin + (k-1)*dz
