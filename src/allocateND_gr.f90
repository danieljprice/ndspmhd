...
!
 ...
 REAL, DIMENSION(ndimV,newsizein) :: dumpmomin,dumvel,dumBevolin
...
!--gr terms
 ...
 REAL, DIMENSION(ndimV,newsizein) :: dumsourceterms,dumpmom
...
!-----------------------------------------------------------------------------
    ...
    dumpmomin(:,1:idumsize) = pmomin(:,1:idumsize)
...
!    dumll(1:idumsize) = ll(1:idumsize)
    ...
    dumpmom(:,1:idumsize) = pmom(:,1:idumsize)
